...
//#endif
	...
	if( hf_link_node_pointer->receive_package_renew[SET_HEAD_1]==1 ){
      ...
      board.analogServoSetPWM(1, (1500+my_robot.expect_head1_state.pitch*50/9));
    }
